...
INSERT INTO `location` (`location_id`, `name`, `lat`, `lon`, `borough`, `address`, `city`, `state`) VALUES(3, 'Grayhawk', 33.6761, -111.9072, '', 'Phoenix, AZ, USA', 'Phoenix', 'AZ');
INSERT INTO `location` (`location_id`, `name`, `lat`, `lon`, `borough`, `address`, `city`, `state`) VALUES(3, 'McCormick Ranch', 33.5609, -111.8984, '', 'Phoenix, AZ, USA', 'Phoenix', 'AZ');
INSERT INTO `location` (`location_id`, `name`, `lat`, `lon`, `borough`, `address`, `city`, `state`) VALUES(3, 'Moon Valley', 33.6212, -112.0722, '', 'Phoenix, AZ, USA', 'Phoenix', 'AZ');